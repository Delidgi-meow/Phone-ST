...
const DICT = {
    ...
    'знаешь только ты': 'only you know this', 'тебе': 'to you', 'это писала ты': 'you sent this',
    ...
    'Это мэтч': "It's a match", 'Написать первой': 'Message them first', 'Свайпать дальше': 'Keep swiping',
    ...
    'Теперь он знает тебя как обычного человека': 'Now they know you like anyone else',
    ...
    'кого и зачем': 'who, and what for', 'рост, сложение, волосы, во что одета': 'height, build, hair, what you wear',
