...
const DICT = {
    ...
    'Нет сообщений — напиши первым': 'No messages — text first',
    ...
    'Нажми ↻ — канал оживёт, или напиши первым': 'Tap ↻ to bring the channel alive, or post first',
    ...
    'Подслушано': 'Overheard', 'Город': 'Town', 'Написать анонимно': 'Post anonymously',
    ...
    'Пробить автора': 'Buy the sender\'s name', 'Пробиваю…': 'Digging…',
    'заплатил админу и знает, что это писала ты': 'paid the admin and knows you wrote it', 'Не надо': 'Never mind', 'Заплатить': 'Pay',
    ...
    'Автора не нашли': 'The sender was never found', 'Пустая анонимка': 'Nothing to send',
    'Это твой собственный пост': 'This one is yours', 'Не хватает денег на карте': 'Not enough money on the card',
    'Город молчит — попробуй ещё раз': 'The town is quiet — try again',
    'Нажми ↻ — город начнёт сплетничать': 'Tap ↻ and the town starts talking',
    'Городские сплетни. Присылают анонимно': 'Town gossip. Sent in anonymously',
    ...
    'Мимо': 'Nope',
    'Анкета в Тиндере': 'Their Tinder profile',
    'Дать свой номер': 'Give them your number', 'Открыть переписку': 'Open the chat',
    'Номер отправлен — теперь вы в «Сообщениях»': 'Number sent — you are in Messages now',
    ...
    'Это мэтч': "It's a match", 'Начать разговор': 'Start the conversation', 'Свайпать дальше': 'Keep swiping',
    'Новые — ещё не писали': 'New — not written to yet', 'Переписка': 'Talking',
    'Убрать мэтч': 'Remove match', 'Убрать мэтч? Контакт в «Сообщениях» останется.': 'Remove the match? The contact in Messages stays.',
    ...
    'чем занимаешься': 'what you do', 'строчка, которую увидят первой': 'the line they see first',
    'кого и зачем': 'who, and what for', 'рост, сложение, волосы, как одеваешься': 'height, build, hair, how you dress',
    'Нарисовать фото': 'Draw a photo', 'Загрузить фото': 'Upload a photo',
    'Как я выгляжу': 'How I look', '(для рисования фото)': '(used to draw the photo)',
    'Кто он': 'Who they are', 'Рост и сложение': 'Height and build', 'Лицо и руки': 'Face and hands',
    'Голос и вещи': 'Voice and things', 'Темперамент и характер': 'Temperament and character',
    'Быт, руки, еда': 'Home, hands, food', 'Как пишет': 'How they text',
    'Когда заинтересован': 'When they are interested', 'В постели': 'In bed', 'Что скрывает': 'What they hide',
    'вы знакомы': 'you know them', 'знакомы вживую': 'met in person',
    'Пока пусто.': 'Empty so far.', 'Генерация картинок не настроена': 'Image generation is not set up',
    ...
    'Планы появятся сами, когда в сцене': 'Plans appear on their own when the scene', 'о чём-то договорятся — или добавь свой': 'agrees on something — or add your own',
    'Перерисовать товар': 'Redraw the item', 'Перерисовать кадр': 'Redraw the frame', 'Кадр перерисован': 'Frame redrawn',
    ...
    'Поиск соберёт каналы этого города и мира,': 'Search will collect the channels of this city and world,',
    'заведёт канал знакомого': 'adds a channel of someone you know',
    ...
    'Нажми ↻ — канал наполнится': 'Tap ↻ — the channel will fill up', 'Пока тихо. Напиши первым': 'Quiet so far. Write the first one',
    'или нажми ↻': 'or tap ↻',
...
const RULES = [
    ...
    [/^Новых анкет: (\d+)$/, 'New profiles: $1'],
    [/^из Тиндера · (.+)$/, 'from Tinder · $1'],
    [/^чат в Тиндере · (.+)$/, 'Tinder chat · $1'],
    [/^(.+) узнал, что анонимку писала ты$/, '$1 found out the anonymous post was yours'],
    [/^(.+) знает, что это ты$/, '$1 knows it was you'],
    [/^(.+) тебя пробил$/, '$1 bought your name'],
    [/^Автор: (.+)$/, 'Sender: $1'],
    [/^Написала? (.+)$/, 'Sent by $1'],
